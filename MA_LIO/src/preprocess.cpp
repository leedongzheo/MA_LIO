...
void Preprocess::process(const sensor_msgs::msg::PointCloud2::ConstPtr &msg, PointCloudXYZI::Ptr &pcl_out, int lidar)
{
...
void Preprocess::oust64_handler(const sensor_msgs::msg::PointCloud2::ConstPtr &msg, int lidar)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
...
void Preprocess::velodyne_handler(const sensor_msgs::msg::PointCloud2::ConstPtr &msg, int lidar)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
